...
<body>
	...
	?>
		<div id="blur" style="background-color: red;position: absolute;left: 37%;width: 25%;text-align: center;">
			<p style="font-size:20px ;">
				<?php
				echo "Newsletter has subscribed";
				?>
			</p>
		</div>
	...
	<?php
		...
		<div id="blur" style="background-color: red;position: absolute;left: 37%;width: 25%;text-align: center;">
			<p style="font-size:20px ;">
				<?php
				echo "Newsletter has subscribed error in email details";
				?>
			</p>
		</div>
	<?php } ?>
					...
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<p>Excepteur sint occaecat laboris nisi ut aliquip ex ea
								commodo consequat.Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
								dolore
								eu fugiat nulla pariatur cupidatat non proident, sunt in culpa qui officia deserunt
