...
<body>
						...
						<div class="col-md-8 modal_body_left modal_body_left1" style="border-right: 1px dotted #C2C2C2;padding-right:3em;">
							<div class="sap_tabs">
								...
								<?php  $flagg=$_GET['flagg'];
									...
									<div id="blurrr" style="background-color: red;width: 100%;text-align: center;">
										<p style="font-size:20px; ;">
											<?php
											session_start();
											echo $_SESSION['login'];
										...
										<div class="facts">
											...
											<div class="register">
												...
												<form id="lform" action="login_validate.php" method="post">
													...
													<input name="Password" placeholder="Password" type="password" required="" minlength="5">
													<div class="sign-up">
										...
										<div class="facts">
											<div class="register">
												<form id="rform" action="registration_valid.php" method="post">
													...
													<input placeholder="Phone Number" name="PhoneNumber" type="number" id="phonenumber" required="">
	...
	<div class="header" id="home1">
		<div class="container">
			<div class="w3l_login">
            <a href="sign_in_up.php" ><span class="glyphicon glyphicon-user" aria-hidden="true"><br>Register</span></a>			</div>
			<div class="w3l_logo">
